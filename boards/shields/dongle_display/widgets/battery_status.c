...
static void draw_battery(lv_obj_t *canvas, uint8_t level, bool usb_present) {
    ...
    lv_canvas_set_px(canvas, 18, 2, lv_color_white());
    lv_canvas_set_px(canvas, 19, 1, lv_color_white());
    lv_canvas_set_px(canvas, 19, 2, lv_color_white());
    ...
    if (level <= 10 || usb_present) {
        lv_canvas_draw_rect(canvas, 1, 1, 17, 8, &rect_fill_dsc);
    } else if (level <= 30) {
        lv_canvas_draw_rect(canvas, 1, 1, 13, 8, &rect_fill_dsc);
    } else if (level <= 50) {
        lv_canvas_draw_rect(canvas, 1, 1, 9, 8, &rect_fill_dsc);
    } else if (level <= 70) {
