...
int zmk_widget_dongle_battery_status_init(struct zmk_widget_dongle_battery_status *widget, lv_obj_t *parent) {
    ...
    for (int i = 0; i < ZMK_SPLIT_BLE_PERIPHERAL_COUNT + SOURCE_OFFSET; i++) {
        ...
        lv_obj_align(image_canvas, LV_ALIGN_TOP_MID, 0, i * 20); // Ajuste o valor de 20 conforme necessário
        lv_obj_align(battery_label, LV_ALIGN_TOP_MID, 0, (i * 20) + 10); // Posicione a label logo abaixo
