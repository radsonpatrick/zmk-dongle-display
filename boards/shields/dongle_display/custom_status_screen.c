...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_display_set_resolution(screen,32,128)
    ...
    // lv_obj_align(zmk_widget_layer_status_obj(&layer_status_widget), LV_ALIGN_BOTTOM_LEFT, 0, 5);
    ...
    // lv_obj_align(zmk_widget_dongle_battery_status_obj(&dongle_battery_status_widget), LV_ALIGN_TOP_RIGHT, 0, 5);
